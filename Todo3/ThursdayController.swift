...
import UIKit
protocol ThursdayControllerDelegate {
    func updateTableView()
}
//classの継承を追加
class ThursdayController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        //戻り値の設定(表示するcell数)
        return AddController.thursdayContent.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        //変数を作る
        let TodoCell : UITableViewCell = tableView.dequeueReusableCell(withIdentifier: "thursday", for: indexPath)
        //変数の中身を作る
        TodoCell.textLabel!.text = AddController.thursdayContent[indexPath.row]
        //戻り値の設定（表示する中身)
        return TodoCell
    }
    ...
    func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        ...
        let deleteButton: UITableViewRowAction = UITableViewRowAction(style: .normal, title: "削除") { (action, index) -> Void in
            AddController.thursdayContent.remove(at: indexPath.row)
            UserDefaults.standard.removeObject(forKey: "thursday")
    ...
    override func viewDidLoad() {
        ...
        if UserDefaults.standard.object(forKey: "thursday") != nil {
            AddController.thursdayContent = UserDefaults.standard.object(forKey: "thursday") as! [String]
        }
    }
    @objc func addTodo(){
