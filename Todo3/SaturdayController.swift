...
import UIKit
protocol SaturdayControllerDelegate {
    func updateTableView()
}
//classの継承を追加
class SaturdayController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        //戻り値の設定(表示するcell数)
        return AddController.saturdayContent.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        //変数を作る
        let TodoCell : UITableViewCell = tableView.dequeueReusableCell(withIdentifier: "saturday", for: indexPath)
        //変数の中身を作る
        TodoCell.textLabel!.text = AddController.saturdayContent[indexPath.row]
        //戻り値の設定（表示する中身)
        return TodoCell
    }
    ...
    func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        ...
        let deleteButton: UITableViewRowAction = UITableViewRowAction(style: .normal, title: "削除") { (action, index) -> Void in
            AddController.saturdayContent.remove(at: indexPath.row)
            UserDefaults.standard.removeObject(forKey: "saturday")
    ...
    override func viewDidLoad() {
        ...
        if UserDefaults.standard.object(forKey: "saturday") != nil {
            AddController.saturdayContent = UserDefaults.standard.object(forKey: "saturday") as! [String]
        }
    }
    @objc func addTodo(){
