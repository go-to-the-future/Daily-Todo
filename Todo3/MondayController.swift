...
protocol MondayControllerDelegate {
...
class MondayController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        //戻り値の設定(表示するcell数)
        return AddController.mondayContent.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        //変数を作る
        let TodoCell : UITableViewCell = tableView.dequeueReusableCell(withIdentifier: "monday", for: indexPath)
        //変数の中身を作る
        TodoCell.textLabel!.text = AddController.mondayContent[indexPath.row]
        //戻り値の設定（表示する中身)
        return TodoCell
    }
    ...
    func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        ...
        let deleteButton: UITableViewRowAction = UITableViewRowAction(style: .normal, title: "削除") { (action, index) -> Void in
            AddController.mondayContent.remove(at: indexPath.row)
            UserDefaults.standard.removeObject(forKey: "monday")
    ...
    override func viewDidLoad() {
        ...
        if UserDefaults.standard.object(forKey: "monday") != nil{
            AddController.mondayContent = UserDefaults.standard.object(forKey: "monday") as! [String]
        }
    }
